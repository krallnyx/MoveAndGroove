class ActivitiesController < ApplicationController
  ...
  def index
    ...
    user_signed_in? 
    @user = current_user
    @activities_user = Activity.where(user_id: current_user.id)
  end
  ...
  private
    ...
    def activity_params
      params.fetch(:activity, {}).permit(:date, :duration, :user_id, :activity_list_id, :intensity, :intensity_to_kcal, :notes)
    end
end
